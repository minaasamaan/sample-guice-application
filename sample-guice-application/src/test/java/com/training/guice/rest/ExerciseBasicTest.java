...
public class ExerciseBasicTest extends AbstractIntegrationTest {
	...
	public void testSelectByDescription() {
		...
		final List<Exercise> selectedExercises = testClientService
				.getExerciseByDescription("Coding Task testSelectByDescription");
	...
	@Test
	public void testSelectByTypeAndDate() throws ParseException {
		...
		final List<Exercise> selectedExercises = testClientService.getExercises(userId, Enums.ExerciseType.OTHER,
				"2016-06-19");
		assertNotNull(selectedExercises);
